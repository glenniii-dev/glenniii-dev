...
export default async function Page({ params }: { params: { id: string } }) {
  ...
  return (
    <main className="w-full max-w-7xl mx-auto items-center px-4 py-10 md:px-6 md:py-14 lg:py-16 bg-slate-900 text-slate-100 lg:rounded-2xl md:my-10 border border-slate-800">
