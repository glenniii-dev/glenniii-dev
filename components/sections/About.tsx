  ...
  return (
    <section className="bg-(--blue) rounded-3xl p-8 shadow-md transition-transform duration-300 hover:-translate-y-1">
        ...
        <div className="about-grid">
          <p className="text-white leading-relaxed">Hey, I&apos;m Glenn, a web developer who&apos;s passionate about crafting clean, engaging websites. I love creating and transforming ideas through code.</p>
